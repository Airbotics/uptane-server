...
export const SEED_PRIMARY_ECU_ID = 'seed-primary-ecu';
export const SEED_SECONDARY_ECU_ID = 'seed-secondary-ecu';
export const SEED_EXPIRES_AT = [10, 'year']; //lets not worry about expiry for seeder